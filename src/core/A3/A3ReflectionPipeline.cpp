...
#include "../../shaders/spv/A3-reflection.vert.inl"
};

static uint32_t frag_code[] = {
#include "../../shaders/spv/A3-reflection.frag.inl"
};

A3ReflectionPipeline::~A3ReflectionPipeline(){
...
void A3ReflectionPipeline::create(
    RTG &rtg, 
	...
	pipeline_name_to_index["A3ReflectionPipeline"] = 3;
}

void A3ReflectionPipeline::destroy(RTG &rtg) {

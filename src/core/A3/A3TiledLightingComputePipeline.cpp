#include "A3TiledLightingComputePipeline.hpp"
#include "Helpers.hpp"
#include "VK.hpp"
...
#include "../../shaders/spv/A3-tiled-lighting.comp.inl"
};

void A3TiledLightingComputePipeline::create(
		RTG &rtg, 
    ...
    pipeline_name_to_index["A3TiledLightingComputePipeline"] = 6;
}

void A3TiledLightingComputePipeline::destroy(RTG &rtg) {
...
A3TiledLightingComputePipeline::~A3TiledLightingComputePipeline() {

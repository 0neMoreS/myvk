...
#include "../../shaders/spv/Deferred-pbr.vert.inl"
};

static uint32_t frag_code[] = {
#include "../../shaders/spv/Deferred-pbr.frag.inl"
};

DeferredPBRPipeline::~DeferredPBRPipeline(){
...
void DeferredPBRPipeline::create(
    RTG &rtg, 
    ...
    { // bind texture descriptors: cubemaps and 2D textures
        ...
        { // allocate texture descriptor and update data
            ...
            // Deferred GBuffer inputs are updated from Deferred::on_swapchain once framebuffer-backed images exist.
        }
    }
    ...
    pipeline_name_to_index["DeferredPBRPipeline"] = 2;
}

void DeferredPBRPipeline::destroy(RTG &rtg) {

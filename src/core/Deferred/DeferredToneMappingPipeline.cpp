...
#include "../../shaders/spv/Deferred-tonemap.vert.inl"
};

static uint32_t frag_code[] = {
#include "../../shaders/spv/Deferred-tonemap.frag.inl"
};

void DeferredToneMappingPipeline::create(
        RTG &rtg,
    ...
    // The HDR texture descriptor will be manually updated in Deferred.cpp
}

void DeferredToneMappingPipeline::destroy(RTG &rtg) {
...
DeferredToneMappingPipeline::~DeferredToneMappingPipeline() {

...
#include "../../shaders/spv/SSAO-ao.vert.inl"
};

static uint32_t frag_code[] = {
#include "../../shaders/spv/SSAO-ao.frag.inl"
};

void SSAOAmbientOcclusionPipeline::create(
    RTG &rtg,
    ...
    pipeline_name_to_index["SSAOAmbientOcclusionPipeline"] = 7;
}

VkDescriptorImageInfo SSAOAmbientOcclusionPipeline::get_noise_descriptor_image_info() const {
...
SSAOAmbientOcclusionPipeline::~SSAOAmbientOcclusionPipeline() {

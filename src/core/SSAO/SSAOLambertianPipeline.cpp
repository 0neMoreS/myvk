...
#include "../../shaders/spv/SSAO-lambertian.vert.inl"
};

static uint32_t frag_code[] = {
#include "../../shaders/spv/SSAO-lambertian.frag.inl"
};

SSAOLambertianPipeline::~SSAOLambertianPipeline(){
...
void SSAOLambertianPipeline::create(
    RTG &rtg, 
    ...
    pipeline_name_to_index["SSAOLambertianPipeline"] = 1;
}

void SSAOLambertianPipeline::destroy(RTG &rtg) {

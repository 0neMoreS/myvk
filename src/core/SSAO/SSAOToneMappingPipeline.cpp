...
#include "../../shaders/spv/SSAO-tonemap.vert.inl"
};

static uint32_t frag_code[] = {
#include "../../shaders/spv/SSAO-tonemap.frag.inl"
};

void SSAOToneMappingPipeline::create(
        RTG &rtg,
    ...
    // The HDR texture descriptor will be manually updated in SSAO.cpp
}

void SSAOToneMappingPipeline::destroy(RTG &rtg) {
...
SSAOToneMappingPipeline::~SSAOToneMappingPipeline() {

...
#include "../../shaders/spv/SSDO-tonemap.vert.inl"
};

static uint32_t frag_code[] = {
#include "../../shaders/spv/SSDO-tonemap.frag.inl"
};

void SSDOToneMappingPipeline::create(
        RTG &rtg,
    ...
    // The HDR texture descriptor will be manually updated in SSDO.cpp
}

void SSDOToneMappingPipeline::destroy(RTG &rtg) {
...
SSDOToneMappingPipeline::~SSDOToneMappingPipeline() {
